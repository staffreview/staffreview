---
name: staff-copy
description: Copy all unresolved GitHub PR review threads from one or more PR URLs into local Staff Review diffs. Use when the user runs /staff-copy with PR URL(s), PR numbers, or owner/repo#number refs and wants open PR review comments mirrored locally.
---
