...
```bash
staff settings get loopMaxRounds       # read a single global setting
```

Settings (theme, split/unified, font size, syntax theme, review-loop cap) live
in the gear menu and persist globally.
