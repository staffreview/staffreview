...
`staff install` writes thirteen skills to `.agents/skills/` (symlinked into
...
`/staff-document`, `/staff-copy`, `/staff-docs`, `/staff-loop`) plus five building
blocks the orchestrators fan out to (`/staff-review-find`, `/staff-review-verify`,
`/staff-section-find`, `/staff-section-verify`, `/staff-docs-scout`).
